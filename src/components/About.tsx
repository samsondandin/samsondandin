...
const About = () => {
  ...
  return (
    <section id="about" className="section-spacing px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-slide-up">
            {highlights.map((highlight, index) => (
              <Card key={index} className="card-gradient border-border hover-glow transition-smooth">
        ...
        <div className="mt-16 text-center animate-fade-in">
          <h3 className="text-2xl font-bold mb-8">Languages I Speak</h3>
          <div className="flex flex-wrap justify-center gap-4">
            <Badge variant="outline" className="text-lg py-2 px-4">🇬🇧 English (Fluent)</Badge>
            <Badge variant="outline" className="text-lg py-2 px-4">🇮🇳 Hindi (Fluent)</Badge>
            <Badge variant="outline" className="text-lg py-2 px-4">🇮🇳 Tamil (Fluent)</Badge>
            <Badge variant="outline" className="text-lg py-2 px-4">🇮🇳 Kannada (Basic)</Badge>
          </div>
        </div>
      </div>
    </section>
