          ...
          >
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="flex flex-col items-center text-center">
                ...
                >
                  <div className="w-14 h-14 rounded-2xl overflow-hidden shadow-lg ring-2 ring-primary/20">
                ...
                >
                  Designed with <Heart size={12} className="text-primary animate-pulse" /> for AI innovation
                </motion.p>
              </div>
            </div>
          </motion.footer>
